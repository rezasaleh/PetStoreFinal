...
namespace PetStoreFinalTest.Controllers
{
    ...
    {
        private readonly PetStoreFinalTestContext _context;
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstName,EnrollmentDate,City,EmailAddress,PhoneNumber,Occupation")] Owner owner)
        {
