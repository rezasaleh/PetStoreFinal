...
namespace PetStoreFinalTest.Controllers
{
    public class PetsController : Controller
    {
        ...
        public PetsController(PetStoreFinalTestContext context)
        {
            _context = context;
        }
        ...
        {
            var petStoreFinalTestContext = _context.Pet.Include(p => p.Owner);
            return View(await petStoreFinalTestContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,DOB,OwnerID,Breed")] Pet pet)
        {
